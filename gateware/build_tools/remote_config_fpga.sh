...
ssh $HOSTNAME "set -e; sudo systemctl stop vvmd; sudo cp -f $FILE_NAME /lib/firmware; echo $FILE_NAME | sudo tee /sys/class/fpga_manager/fpga0/firmware; dmesg | tail -n 1"
